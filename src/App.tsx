...
// Fix the Tool icon issue in TradecraftHome.tsx
<lov-write file_path="src/templates/tradecraft/Home.tsx">
...
import { Calendar, Phone, Wrench, Check, Settings } from 'lucide-react';
            ...
            <div className="lg:w-1/2 mb-10 lg:mb-0">
              ...
              <div className="flex flex-wrap gap-4">
                <Button asChild size="lg" className="bg-orange-500 hover:bg-orange-600 text-white">
                  <Link to="/tradecraft">Our Services</Link>
                </Button>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mt-10">
            <Button asChild variant="outline">
              <Link to="/tradecraft">View All Services</Link>
            </Button>
          </div>
        </div>
      </section>
